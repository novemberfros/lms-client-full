...
const LibraryCarousel = () => {
  return (
    <Carousel>
      <Carousel.Item>
        <img className='d-block w-100' height={400} src={LMS_CAROUSEL_IMAGE1} alt="Image" />
      </Carousel.Item>

      <Carousel.Item>
        <img className='d-block w-100' height={400} src={LMS_CAROUSEL_IMAGE2} alt="Image" />
      </Carousel.Item>

      <Carousel.Item>
        <img className='d-block w-100' height={400} src={LMS_CAROUSEL_IMAGE3} alt="Image" />
      </Carousel.Item>

      <Carousel.Item>
        <img className='d-block w-100' height={400} src={LMS_CAROUSEL_IMAGE4} alt="Image" />
      </Carousel.Item>
    </Carousel>
  );
}
